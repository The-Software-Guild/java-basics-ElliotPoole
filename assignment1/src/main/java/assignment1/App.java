package assignment1.src.main.java;
    ...
    public static void main( String[] args )
    {
        ...
        switch(program){
            ...
            case 2:
                ...
                //calculates the percentage for the last breed base on what is left
                if(!maxPercent){ //the remaining percentage needed to get to 100%
                    percent = 100-PercentTotal;
                    System.out.println(percent+"% "+dogBreeds[index] + "\n");
                }else{ //if the total percentage has reached 100%
                    System.out.println("0% "+dogBreeds[index]+ "\n");
                }
